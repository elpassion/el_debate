...
describe ARStream::Forward do
  ...
  describe '#next' do
    ...
    it 'returns records sorted by id ascending' do
      expect(subject).to eq(subject.sort_by(&:id))
    end
    ...
    context 'when stream started with id provided' do
      ...
      it 'returns records with id higher or equal to provided' do
